-- Descrição: Expande pre_patients para funil de crescimento com receita, origem, temperatura e ações comerciais
-- Data: 2026-04-18
-- Autor: Codex
...
COMMENT ON VIEW public.vw_growth_funnel_metrics IS 'Métricas consolidadas de funil de crescimento baseadas em pre_patients';
...
COMMENT ON VIEW public.vw_growth_channel_metrics IS 'Métricas por canal de origem para análise de conversão e ROI estimado';
