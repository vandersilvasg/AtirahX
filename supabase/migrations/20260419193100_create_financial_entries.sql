-- Reconcile financial entries schema in Supabase CLI history.
-- This is the Supabase CLI tracked equivalent of legacy migration 60.
...
COMMENT ON TABLE public.financial_entries IS 'Manual financial entries for revenue and expense consolidation.';
COMMENT ON COLUMN public.financial_entries.type IS 'income or expense';
COMMENT ON COLUMN public.financial_entries.amount IS 'Monetary value in BRL';
COMMENT ON COLUMN public.financial_entries.occurred_at IS 'Accounting date of the entry';
