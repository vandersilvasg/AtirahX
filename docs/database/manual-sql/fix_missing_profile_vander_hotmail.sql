...
BEGIN
    ...
    SELECT * INTO v_user_record FROM auth.users WHERE email = 'vandersilvasg@hotmail.com';
    ...
    IF v_user_record.id IS NOT NULL THEN
        ...
        END IF;
    ELSE
        RAISE NOTICE 'Usuário com email vandersilvasg@hotmail.com não encontrado em auth.users';
    END IF;
END $$;
